...
{
public:
	SampleViewer(const char* strSampleName, openni::VideoStream& depth1, openni::VideoStream& depth2, openni::VideoStream& color1, openni::VideoStream &color2);//jsyeh add color
...
private:
	...
	//jsyeh begin
	openni::VideoStream&		m_color1;
	openni::VideoStream&		m_color2;
	openni::VideoFrameRef	m_color1Frame;
	openni::VideoFrameRef	m_color2Frame;
	//jsyeh end
