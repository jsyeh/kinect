...
int main(int argc, char** argv)
{
	...
	//jsyeh begin
	openni::VideoStream color1, color2;
	//jsyeh end
	...
	printf("deviceList[1].getUri(): %s\n", device1Uri);
	printf("deviceList[0].getUri(): %s\n", device1Uri);
	...
	//jsyeh begin
	color1.create(device1, openni::SENSOR_COLOR);
	color2.create(device2, openni::SENSOR_COLOR);
	color1.start();
	color2.start();
	//jsyeh end
	...
	SampleViewer sampleViewer("Simple Viewer", depth1, depth2, color1, color2);
